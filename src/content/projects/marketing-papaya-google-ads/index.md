...
technologies:
  ...
  - Illustrator
  - Photoshop
featuredImage: ./thumb-marketing-papaya-google-ads.png
...
![](./marketing-papaya-landing-page.png)

## Formulario Avanzado

El formulario valida que no hayan campos vacíos, y lo mejor es que el usuario puede seleccionar su país al momento de agregar su número de celular, de esta forma la landing page puede ser expuesta sin problemas a ciudadanos de diferentes países.

![](./formulario-google-ads.png)

## Responsive

![](./responsive-google-ads-mtk-papaya.png)
